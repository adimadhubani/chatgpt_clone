...
const ParagraphCard = styled(Card)({
    ...
    >
      <Box position="relative" zIndex={1}>
            ...
            InputProps={{
              startAdornment: (
                <InputAdornment position="start">
                  <Terminal sx={{ color: "rgba(0, 255, 170, 0.7)" }} />
                </InputAdornment>
              ),
        ...
        >
          {para ? (
            <>
              ...
              <TerminalText variant="body1" whiteSpace="pre-wrap">
                {para}
              </TerminalText>
            </>
          ) : (
            <Box
              ...
              textAlign="center"
            >
              <Article sx={{ fontSize: "4rem", color: "rgba(0, 255, 170, 0.3)", mb: 2 }} />
              <TerminalText variant="h6" color="rgba(0, 255, 170, 0.5)">
                 GENERATED_TEXT_WILL_APPEAR_HERE
              </TerminalText>
            </Box>
          )}
        </ParagraphCard>
        ...
        <TerminalText variant="caption" sx={{ opacity: 0.7 }}>
          SYSTEM_STATUS: {para ? "PARAGRAPH_GENERATED" : "AWAITING_INPUT"} | 
